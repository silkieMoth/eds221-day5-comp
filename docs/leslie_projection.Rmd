...
# The line below...
# set time_yr to each year that leslie matrix will be run
time_yr <- seq(from = 0, to = 8, by = 1)

# The line below...
#make blank matrix for outputs to go into
proj_year <- matrix(ncol = length(fish_year0), nrow = length(time_yr))

# The line below...
# insert initial conditions into matrix
proj_year[1, ] <- fish_year0

# The for loop below...
# for each year, run through the matrix and insert values by conditions in the leslie matrix
# previous years pops by the values in leslie matrix
